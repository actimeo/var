...
export class Personmenu {
    ...
    doRename() {
        this.pgService.pgcall('portal', 'personmenu_rename', {
    ...
    // Delete
    onDelete() {
        this.pgService.pgcall('portal', 'personmenu_delete', {
            prm_id: this.menu.pme_id
        })
            .then(data => {
                this.onchange.emit(null);
    ...
    onMove() {
        ...
        this.pgService.pgcall('portal', 'personmenu_list', {
    ...
    doMove() {
        this.pgService.pgcall('portal', 'personmenu_move_before_position', {
            prm_id: this.menu.pme_id,
