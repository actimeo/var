...
export class PortalSelect {
    ...
    onDeletePortal() {
        this.pgService.pgcall('portal', 'portal_delete', {
            prm_id: this.selectedPortal.por_id
        })
            .then(data => {
                this.unselectPortal();
    ...
    doAddPortal() {
        this.pgService.pgcall('portal', 'portal_add', {
    ...
    doRenamePortal() {
        this.pgService.pgcall('portal', 'portal_rename', {
            prm_id: this.selectedPortal.por_id,
            prm_name: this.portalName
        })
            .then(data => {
