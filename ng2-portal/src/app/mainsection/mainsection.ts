...
export class Mainsection {
    ...
    reloadMenus() {
        this.pgService.pgcall('portal', 'mainmenu_list', {
    ...
    // Delete
    onDeleteSection() {
        this.pgService.pgcall('portal', 'mainsection_delete', {
    ...
    doRename() {
        this.pgService.pgcall('portal', 'mainsection_rename', {
            prm_id: this.section.mse_id,
            prm_name: this.newName
        })
            .then(data => {
    ...
    onMoveSection() {
        ...
        this.pgService.pgcall('portal', 'mainsection_list', {
    ...
    doMove() {
        this.pgService.pgcall('portal', 'mainsection_move_before_position', {
            prm_id: this.section.mse_id,
            prm_position: this.beforePos
        })
            .then(data => {
                this.onchange.emit(null);
