...
export class PortalService {
	...
	return new Promise((resolve, reject) => {
	    PgProc('/portal/ajax/', 'portal', 'mainsection_move_before_position', { prm_token: this.token, prm_id: id, prm_position: pos })
		.then(resolve, reject);
	});	
    }
	...
	return new Promise((resolve, reject) => {
	    PgProc('/portal/ajax/', 'portal', 'personsection_move_before_position', { prm_token: this.token, prm_id: id, prm_position: pos })
		.then(resolve, reject);
	});	
    }
