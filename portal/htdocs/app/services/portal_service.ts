...
export class PortalService {
  ...
  addPortal(name) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'portal_add', {
        prm_token : this.token,
        prm_name : name
      }).then(resolve, reject);
    });
  ...
  renamePortal(id, name) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'portal_rename',
             {prm_token : this.token, prm_id : id, prm_name : name})
          .then(resolve, reject);
    });
  }
  ...
  deletePortal(id) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'portal_delete', {
        prm_token : this.token,
        prm_id : id
      }).then(resolve, reject);
    });
  ...
  addMainsection(porId, name) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'mainsection_add',
             {prm_token : this.token, prm_por_id : porId, prm_name : name})
          .then(resolve, reject);
    });
  }
  ...
  deleteMainsection(id) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'mainsection_delete', {
        prm_token : this.token,
        prm_id : id
      }).then(resolve, reject);
    });
  ...
  moveMainsection(id, pos) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'mainsection_move_before_position',
             {prm_token : this.token, prm_id : id, prm_position : pos})
          .then(resolve, reject);
    });
  }
  ...
  addPersonsection(porId, entity, name) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'personsection_add', {
        prm_token : this.token,
        prm_por_id : porId,
        prm_entity : entity,
        prm_name : name
  ...
  deletePersonsection(id) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'personsection_delete', {
        prm_token : this.token,
        prm_id : id
      }).then(resolve, reject);
    });
  ...
  addPersonmenu(pseId, name) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'personmenu_add',
             {prm_token : this.token, prm_pse_id : pseId, prm_name : name})
          .then(resolve, reject);
    });
  }
  ...
  deletePersonmenu(id) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'personmenu_delete', {
        prm_token : this.token,
        prm_id : id
      }).then(resolve, reject);
    });
  ...
  addMainmenu(mseId, name) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'mainmenu_add',
             {prm_token : this.token, prm_mse_id : mseId, prm_name : name})
          .then(resolve, reject);
    });
  }
  ...
  deleteMainmenu(id) {
    return new Promise((resolve, reject) => {
      PgProc('/portal/ajax/', 'portal', 'mainmenu_delete', {
        prm_token : this.token,
        prm_id : id
      }).then(resolve, reject);
    });
