  ...
  doRename() {
    this._portalService.renamePersonmenu(this.menu.pme_id, this.menu.pme_name)
        ...
        .catch(err => {
          console.log("err " + err);
          this.alerts.danger(
              this.i18n.t('portal.alerts.error_renaming_personmenu'));
        });
  }
  ...
  onDelete() {
    this._portalService.deletePersonmenu(this.menu.pme_id)
        ...
        .catch(err => {
          console.log("err " + err);
          this.alerts.danger(
              this.i18n.t('portal.alerts.error_deleting_personmenu'));
        });
  }
  ...
  doMove() {
    ...
    this._portalService.movePersonmenu(this.menu.pme_id, this.before_pos)
        ...
        .catch(err => {
          console.log("err " + err);
          this.alerts.danger(
              this.i18n.t('portal.alerts.error_moving_personmenu'));
        });
  }
